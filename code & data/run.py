...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='CastorTS')
    ...
    parser.add_argument('--model', type=str, default='CastorTS', help='model name, options: [CastorTS_CL, CastorTS, Chronos, Moirai, Timer, TimesFM]')

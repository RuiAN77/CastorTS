...
do
  torchrun --nnodes=1 --nproc_per_node=2 --master_port=29501 run.py \
    ...
    --patience 6 \
    --use_multi_gpu \
    --itr 1 >logs/Pretrain/CastorTS_CL_$data_name'_'$seq_len'_'$pred_len'_is_pretraining.log'
done
...
do
  torchrun --nnodes=1 --nproc_per_node=2 --master_port=29501 run.py \
    ...
    --patience 6 \
    --use_multi_gpu \
    --itr 1 >logs/Pretrain/CastorTS_$data_name'_'$seq_len'_'$pred_len'_is_tuning.log'
done
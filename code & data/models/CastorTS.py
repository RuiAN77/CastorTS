...
from layers.CastorTS_EncDec import TSTEncoder, TowerEncoder, MixtrueExpertsLayer, PredictionHead, PretrainHead
...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        if configs.data == 'UTSD':
            setting = re.sub(r'_CastorTS_', '_CastorTS_CL_', configs.setting)
